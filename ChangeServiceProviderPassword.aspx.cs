...
public partial class ChangeServiceProviderPassword : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (oldpas != nepas)
        {
            if (nepas == conpas)
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("update serviceproviderregister set passwo=" + nepas + " where id=" + ide + "", con);
